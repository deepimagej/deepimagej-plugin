...
public class PreprocessingStamp extends AbstractStamp implements ActionListener {
	...
	public PreprocessingStamp(BuildDialog parent) {
		super(parent);
		...
		commands.put("Clip to a minimun value", "run(\"Min...\", \"value=0 stack\");");
		commands.put("Clip to a minimun value", "run(\"Min...\", \"value=0 stack\");");
		commands.put("Clip to a maximun value", "run(\"Max...\", \"value=255 stack\");");
		commands.put("Normalization to mean (0) and stdev (1)", "getRawStatistics(nPixels, mean, min, max, std, histogram);\n"
	...
	public void buildPanel() {
		...
		pane.append("h2", "Preprocessing Macro");
		pane.append("p", "Edit the preprocessing macro in the black window " + "or add one of the usual macro commands listed below."
	...
	public boolean finish() {
		parent.getDeepPlugin().params.premacro = txt.getText();
		return true;
	}
