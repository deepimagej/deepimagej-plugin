...
public class PreprocessStamp extends AbstractStamp implements ActionListener {
	...
	public PreprocessStamp(Parameters params, BuildDialog parent, String title) {
	...
	public void validate() {
		...
		params.premacro = preprocessing_script;
	}
